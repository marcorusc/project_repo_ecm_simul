...
class UserTab(object):
    ...
    def __init__(self):
        ...
        param_name2 = Button(description='migration_bias', disabled=True, layout=name_button_layout)
        ...
        param_name4 = Button(description='persistence', disabled=True, layout=name_button_layout)
        ...
        param_name5 = Button(description='motility_amplitude_min', disabled=True, layout=name_button_layout)
        ...
        param_name6 = Button(description='motility_amplitude_max', disabled=True, layout=name_button_layout)
        ...
        param_name7 = Button(description='mode_motility', disabled=True, layout=name_button_layout)
        ...
        param_name8 = Button(description='contact_cell_ECM_threshold', disabled=True, layout=name_button_layout)
        ...
        param_name9 = Button(description='contact_TGFB_threshold', disabled=True, layout=name_button_layout)
        ...
        param_name10 = Button(description='ECM_TGFbeta_ratio', disabled=True, layout=name_button_layout)
        ...
        param_name11 = Button(description='contact_cell_cell_threshold', disabled=True, layout=name_button_layout)
        ...
        param_name19 = Button(description='ecm_cell_contact_factor', disabled=True, layout=name_button_layout)
        ...
        param_name20 = Button(description='initial_cell_contact_parameter', disabled=True, layout=name_button_layout)
        ...
        desc_button2 = Button(description='change value of migration bias for cells with migration node active' , tooltip='change value of migration bias for cells with migration node active', disabled=True, layout=desc_button_layout) 
        desc_button2.style.button_color = 'tan'
        desc_button3 = Button(description='change value of migration speed for cells with migration node active' , tooltip='change value of migration speed for cells with migration node active', disabled=True, layout=desc_button_layout) 
        desc_button3.style.button_color = 'lightgreen'
        desc_button4 = Button(description='change value of persistence for cells with migration node active' , tooltip='change value of persistence for cells with migration node active', disabled=True, layout=desc_button_layout) 
        desc_button4.style.button_color = 'tan'
        desc_button5 = Button(description='change the min value of motility amplitude' , tooltip='change the min value of motility amplitude', disabled=True, layout=desc_button_layout) 
        desc_button5.style.button_color = 'lightgreen'
        desc_button6 = Button(description='change the max value of motility amplitude' , tooltip='change the max value of motility amplitude', disabled=True, layout=desc_button_layout) 
        desc_button6.style.button_color = 'tan'
        desc_button7 = Button(description='not used yet' , tooltip='not used yet', disabled=True, layout=desc_button_layout) 
        desc_button7.style.button_color = 'lightgreen'
        desc_button8 = Button(description='change the threshold needed to trigger ECM interaction' , tooltip='change the threshold needed to trigger ECM interaction', disabled=True, layout=desc_button_layout) 
        desc_button8.style.button_color = 'tan'
        desc_button9 = Button(description='change the threshold needed to trigger TGFbeta interaction' , tooltip='change the threshold needed to trigger TGFbeta interaction', disabled=True, layout=desc_button_layout) 
        ...
        desc_button11 = Button(description='change the treshold needed to trigger Neighbours and Neigh2 node' , tooltip='change the treshold needed to trigger Neighbours and Neigh2 node', disabled=True, layout=desc_button_layout) 
        ...
        desc_button16 = Button(description='used to set the min adhesion between cells and ECM' , tooltip='used to set the min adhesion between cells and ECM', disabled=True, layout=desc_button_layout) 
        ...
        desc_button18 = Button(description='change the value of ECM repulsion' , tooltip='change the value of ECM repulsion', disabled=True, layout=desc_button_layout) 
        desc_button18.style.button_color = 'tan'
        desc_button19 = Button(description='change the amount of ecm_contact needed to a cell to detach from the others' , tooltip='change the amount of ecm_contact needed to a cell to detach from the others', disabled=True, layout=desc_button_layout) 
        desc_button19.style.button_color = 'lightgreen'
        desc_button20 = Button(description='set the initial amount of cell_contact allowing the immediate activation of Neighbours/Nei2 nodes in the boolean network' , tooltip='set the initial amount of cell_contact allowing the immediate activation of Neighbours/Nei2 nodes in the boolean network', disabled=True, layout=desc_button_layout) 
        ...
        row2 = [param_name2, self.migration_bias, units_button2, desc_button2] 
        row3 = [param_name3, self.migration_speed, units_button3, desc_button3] 
        row4 = [param_name4, self.persistence, units_button4, desc_button4] 
        row5 = [param_name5, self.motility_amplitude_min, units_button5, desc_button5] 
        row6 = [param_name6, self.motility_amplitude_max, units_button6, desc_button6] 
        row7 = [param_name7, self.mode_motility, units_button7, desc_button7] 
        row8 = [param_name8, self.contact_cell_ECM_threshold, units_button8, desc_button8] 
        row9 = [param_name9, self.contact_TGFB_threshold, units_button9, desc_button9] 
        row10 = [param_name10, self.ECM_TGFbeta_ratio, units_button10, desc_button10] 
        row11 = [param_name11, self.contact_cell_cell_threshold, units_button11, desc_button11] 
        ...
        row19 = [param_name19, self.ecm_cell_contact_factor, units_button19, desc_button19] 
        row20 = [param_name20, self.initial_cell_contact_parameter, units_button20, desc_button20] 
