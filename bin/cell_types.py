...
class CellTypesTab(object):
    ...
    def __init__(self):
        ...
        self.float0 = FloatText(value='5.31667e-05', step='1e-05', style=style, layout=widget_layout)
        ...
        name_btn = Button(description='exit rate from apoptotic phase', disabled=True, layout=name_button_layout)
        ...
        row = [self.bool0, name_btn, self.float1, units_btn, ]
        ...
        self.bool1 = Checkbox(description='fixed_duration', value=False,layout=name_button_layout)
        name_btn = Button(description='exit rate from necrotic swelling phase', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'tan'
        self.float3 = FloatText(value='9e9', step='100000000', style=style, layout=widget_layout)
        units_btn = Button(description='1/min', disabled=True, layout=name_button_layout)
        units_btn.style.button_color = 'tan'
        row = [self.bool1, name_btn, self.float3, units_btn, ]
        ...
        name_btn = Button(description='exit rate from necrotic lysed phase', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'lightgreen'
        self.float4 = FloatText(value='1.15741e-5', step='1e-06', style=style, layout=widget_layout)
        units_btn = Button(description='1/min', disabled=True, layout=name_button_layout)
        units_btn.style.button_color = 'lightgreen'
        row = [self.bool2, name_btn, self.float4, units_btn, ]
        ...
        self.bool3 = Checkbox(description='enabled', value=False,layout=name_button_layout)
        self.bool4 = Checkbox(description='use_2D', value=False,layout=name_button_layout)
        #  ------------------------- 
        ...
        self.bnd_filename = Text(value='../data/boolean_network/CCM_mod4_1.bnd', style=style, layout=widget_layout)
        row = [bnd_filename, self.bnd_filename]
        ...
        self.cfg_filename = Text(value='../data/boolean_network/CCM_mod4_1.cfg', style=style, layout=widget_layout)
        row = [cfg_filename, self.cfg_filename]
        ...
        name_btn = Button(description='ECM_sensing', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'tan'
        ...
        name_btn = Button(description='Apoptosis', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'lightgreen'
        self.float10 = FloatText(value='0.01', step='0.001', style=style, layout=widget_layout)
        units_btn = Button(description='dimensionless', disabled=True, layout=name_button_layout)
        units_btn.style.button_color = 'lightgreen'
        ...
        name_btn = Button(description='Hypoxia', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'tan'
        self.float11 = FloatText(value='1.0', step='0.1', style=style, layout=widget_layout)
        units_btn = Button(description='dimensionless', disabled=True, layout=name_button_layout)
        units_btn.style.button_color = 'tan'
...
#      ================== <custom_data>, if present ==================
        ...
        self.cell_def_vbox0 = VBox([
          div_row1, div_row2, death_model1,box0, box1, death_model2,box2, box3, box4, div_row3, box5,box6,box7,self.bool3,self.bool4,div_row4, box8,box9,box10,intracellular_initial_values,box11, box12, intracellular_mutations,box13,         ])
        # ------------------------------------------
...
self.cell_def_vbox0,         ])
    ...
    def fill_gui(self, xml_root):
        ...
        # ---------  death 
        self.float0.value = float(uep.find('.//cell_definition[1]//phenotype//death//model[1]//death_rate').text)
        self.bool0.value = ('true' == (uep.find('.//cell_definition[1]//phenotype//death//model[1]//transition_rates//rate[1]').attrib['fixed_duration'].lower()))
        self.float1.value = float(uep.find('.//cell_definition[1]//phenotype//death//model[1]//transition_rates//rate[1]').text)
        self.float2.value = float(uep.find('.//cell_definition[1]//phenotype//death//model[2]//death_rate').text)
        self.bool1.value = ('true' == (uep.find('.//cell_definition[1]//phenotype//death//model[2]//transition_rates//rate[1]').attrib['fixed_duration'].lower()))
        self.float3.value = float(uep.find('.//cell_definition[1]//phenotype//death//model[2]//transition_rates//rate[1]').text)
        self.bool2.value = ('true' == (uep.find('.//cell_definition[1]//phenotype//death//model[2]//transition_rates//rate[2]').attrib['fixed_duration'].lower()))
        self.float4.value = float(uep.find('.//cell_definition[1]//phenotype//death//model[2]//transition_rates//rate[2]').text)
        # ---------  motility 
        ...
        self.bool3.value = ('true' == (uep.find('.//cell_definition[1]//phenotype//motility//options//enabled').text.lower()))
        self.bool4.value = ('true' == (uep.find('.//cell_definition[1]//phenotype//motility//options//use_2D').text.lower()))
        # ---------  intracellular
        self.bnd_filename.value = float(uep.find('.//cell_definition[1]//phenotype//intracellular//bnd_filename').text)
        self.cfg_filename.value = float(uep.find('.//cell_definition[1]//phenotype//intracellular//cfg_filename').text)
        ...
        self.float11.value = float(uep.find('.//cell_definition[1]//phenotype//intracellular//mutations//mutation[1]').text)
    ...
    def fill_xml(self, xml_root):
        ...
        # ---------  cycle (advanced_Ki67_cycle_model)
        # ---------  death 
        uep.find('.//cell_definition[1]//phenotype//death//model[1]//death_rate').text = str(self.float0.value)
        uep.find('.//cell_definition[1]//phenotype//death//model[1]//transition_rates//rate[1]').attrib['fixed_duration'] = str(self.bool0.value)
        uep.find('.//cell_definition[1]//phenotype//death//model[1]//transition_rates//rate[1]').text = str(self.float1.value)
        uep.find('.//cell_definition[1]//phenotype//death//model[2]//death_rate').text = str(self.float2.value)
        uep.find('.//cell_definition[1]//phenotype//death//model[2]//transition_rates//rate[1]').attrib['fixed_duration'] = str(self.bool1.value)
        uep.find('.//cell_definition[1]//phenotype//death//model[2]//transition_rates//rate[1]').text = str(self.float3.value)
        uep.find('.//cell_definition[1]//phenotype//death//model[2]//transition_rates//rate[2]').attrib['fixed_duration'] = str(self.bool2.value)
        uep.find('.//cell_definition[1]//phenotype//death//model[2]//transition_rates//rate[2]').text = str(self.float4.value)
        # ---------  motility 
        ...
        uep.find('.//cell_definition[1]//phenotype//motility//options//enabled').text = str(self.bool3.value)
        uep.find('.//cell_definition[1]//phenotype//motility//options//use_2D').text = str(self.bool4.value)
        # ---------  intracellular
        uep.find('.//cell_definition[1]//phenotype//intracellular//bnd_filename').text = str(self.bnd_filename.value)
        uep.find('.//cell_definition[1]//phenotype//intracellular//cfg_filename').text = str(self.cfg_filename.value)
        ...
        uep.find('.//cell_definition[1]//phenotype//intracellular//mutations//mutation[1]').text = str(self.float11.value)
